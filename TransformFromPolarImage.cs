/************************************************************Abhisek Hazra, 31.12.2013*************************************************************/
                       /* The image processing routine is oposite transformation to the one done by TransformToPolar routine, 
           * i.e. transformation from polar image into rectangle. The produced effect is similar to GIMP's "Polar Coordinates" distortion filter 
...
{
    public partial class TransformFromPolarImage : Form
    {
        ...
        public TransformFromPolarImage()
        {
            InitializeComponent();
        }
